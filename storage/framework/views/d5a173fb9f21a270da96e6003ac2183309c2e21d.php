...
<?php echo $__env->make('layouts.common.title', ['title' => 'নতুন পদমর্যাদা তৈরী করুন', 'link' => 'Test Link'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<div class="col-xs-12">
			...
			<div class="tab-content rendering-content">
				<div class="tab-pane active" id="tabLeaves">
					<?php echo $__env->make('settings.roles.views._create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
	</div>
